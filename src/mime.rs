/// shamelessly copied from https://github.com/Lynnesbian/new_mime_guess/blob/master/src/mime_types.rs
/// but only took first value of the mime type.
const MIME_TYPES: &[(&str, &str)] = &[
    ...
    ("fsscript", "text/fsharp-script"),
    ("fst", "image/vnd.fst"),
    ("fsx", "text/fsharp-script"),
...
pub(crate) fn mime(ext: &str) -> &'static str {
    match MIME_TYPES.binary_search_by_key(&ext, |&(k, _)| k) {
        Ok(i) => MIME_TYPES[i].1,
